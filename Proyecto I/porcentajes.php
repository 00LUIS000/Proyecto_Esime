...
<body>
  ...
  <li class="list-group-item list-group-item-warning" style="margin-top:95px; background:  #ffd3a9;"><a  style="text-decoration: none; font-size: 25px; " href="iniciosesion.php">Salir de la cuenta</a></li>
    ...
    <section style=" background: lightblue; width: 66%; display: ; height: 520px;  border-radius: 1em;  justify-content: ; align-items: ; " >
                 ...
                 <h8 style=" margin-left: 35px; margin-top: 10px">Pantalla de Porcentaje de asistencia</h8>><br>
            <p></p>
        ...
        <a  style="display: inline-block; width:175px;"  name="ClicA" id="CliA" class="btn btn btn-outline-warning" href="iniciosesion.php" role="button">Buscar por Grupo, Materia</a>
       ...
       <a  style="margin-left: 75px; display: inline-block"  name="ClicA" id="CliA" class="btn btn btn-outline-warning" href="iniciosesion.php" role="button">Seleccionar Todo</a>
        ...
        <a  style="display: inline-block; width:205px; margin-left: 45px;"  name="ClicA" id="CliA" class="btn btn btn-outline-warning" href="iniciosesion.php" role="button">Optener porcentaje de lo seleccionado </a>
